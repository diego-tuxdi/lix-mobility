...
const benefits = [
  ...
  { title: "Comunidad exclusiva", copy: "Formá parte de una red de capitanes profesionales con soporte 24/7.", icon: Award },
] as const;
...
const requirements = [
  ...
  { title: "Antecedentes limpios", copy: "Certificado de antecedentes penales emitido de forma reciente.", icon: Shield },
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Necesitás tu DNI (mayor de 18 años), carnet de habilitación náutica oficial vigente (Conductor Náutico o Timonel), matrícula de la embarcación al día, elementos de seguridad obligatorios por Prefectura y certificado de antecedentes penales."
  },
  {
  ...
  <section className="hero-grid overflow-hidden bg-blush pt-32 sm:pt-40"><Container className="grid min-h-[720px] items-center gap-12 pb-20 lg:grid-cols-[1.05fr_.95fr]">
    ...
    <ScrollReveal delay={200} className="relative">
      <PhoneMockup
        ...
        alt="Pantalla de acceso de Lix Mobility Captain"
        priority
